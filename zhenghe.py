...
if __name__ == '__main__':
    ...
    parser.add_argument('--fasta', required=True, help='输入fasta序列文件路径')
    parser.add_argument('--seqcsv', required=True, help='输出sequence.csv文件路径')
    args = parser.parse_args()

    fasta_path = args.fasta
    sequence_txt_path = args.seqcsv
